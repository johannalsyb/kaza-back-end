...
export const GMAPS_APIKEY = process.env.GMAPS_APIKEY || "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"
export const GMAPS_WEB_APIKEY = process.env.GMAPS_WEB_APIKEY || "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"
