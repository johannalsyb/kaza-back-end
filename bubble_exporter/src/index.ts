...
import Property from "@kazaswap/common/lib/types/Property";
import { Chat } from "@kazaswap/common/lib/types/SwapRequest";
import { BubbleApiResponse, BubbleChat, BubbleMessage, BubbleProperty, BubblePropertyRooms, BubbleUser } from "./types";
import { dal } from "./dal";
import { requestApi } from "./utils";

const BUBBLE_BASE_URL = "https://app.kazaswap.co/version-6qg3/api/1.1/obj/"
...
const getUsers = (bUsers:BubbleUser[], bProperties:BubbleProperty[]) => bUsers.map(async bUser => {
    ...
    try {
        ...
        const u:User = {
            ...
            emailVerified: bUser.authentication.email ? !!bUser.authentication.email.email_confirmed : (!!bUser.authentication.Google),
